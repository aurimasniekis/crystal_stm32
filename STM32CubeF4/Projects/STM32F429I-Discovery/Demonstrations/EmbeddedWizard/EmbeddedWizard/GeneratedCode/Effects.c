...
/* Garbage Collector method for the class 'Effects::RectEffect' */
void EffectsRectEffect__Mark( EffectsRectEffect _this )
{
  EwMarkRef( _this->Outlet );
...
EW_DEFINE_CLASS( EffectsRectEffect, EffectsEffect, "Effects::RectEffect" )
