...
#ifndef _ClimateButton_H
#define _ClimateButton_H
...
/* Forward declaration of the class Climate::Button */
#ifndef _ClimateButton_
  EW_DECLARE_CLASS( ClimateButton )
#define _ClimateButton_
#endif
...
EW_DEFINE_FIELDS( ClimateButton, CoreGroup )
...
EW_END_OF_FIELDS( ClimateButton )

/* Virtual Method Table (VMT) for the class : 'Climate::Button' */
EW_DEFINE_METHODS( ClimateButton, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ClimateButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ClimateButton )
