...
/* Bitmap resource for the Embedded Wizard logo. */
EW_DECLARE_BITMAP_RES( AcceleratorChromArt )
...
enum
{
  AcceleratorGraphicsTypeRectCopy       = 0,
  AcceleratorGraphicsTypeRectBlend      = 1,
  AcceleratorGraphicsTypeBmpCopy        = 2,
  AcceleratorGraphicsTypeBmpBlend       = 3,
  AcceleratorGraphicsTypeAlphaBmp       = 4
};
