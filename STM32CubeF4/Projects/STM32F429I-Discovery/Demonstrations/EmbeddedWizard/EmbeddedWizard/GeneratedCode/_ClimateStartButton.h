...
#ifndef _ClimateStartButton_H
#define _ClimateStartButton_H
...
/* Forward declaration of the class Climate::StartButton */
#ifndef _ClimateStartButton_
  EW_DECLARE_CLASS( ClimateStartButton )
#define _ClimateStartButton_
#endif
...
EW_DEFINE_FIELDS( ClimateStartButton, CoreGroup )
  EW_OBJECT  ( Wallpaper,       ViewsWallpaper )
...
EW_END_OF_FIELDS( ClimateStartButton )

/* Virtual Method Table (VMT) for the class : 'Climate::StartButton' */
EW_DEFINE_METHODS( ClimateStartButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ClimateStartButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ClimateStartButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ClimateStartButton )
